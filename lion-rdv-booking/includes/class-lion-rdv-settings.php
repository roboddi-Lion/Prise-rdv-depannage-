	...
	public static function default_services() {
		return array(
			...
			'depannage_clim_pac'        => array(
				...
				'technician_ids'     => array(),
				'notification_email' => 'contact@lion-renovation.fr',
			),
	...
	public function sanitize_settings( $input ) {
		...
		foreach ( $defaults['services'] as $key => $default_service ) {
			...
			$clean['services'][ $key ] = array(
				...
				'notification_email' => isset( $service_input['notification_email'] ) ? sanitize_email( $service_input['notification_email'] ) : '',
			);
		}
